            ...
            <tbody>
                <?php
                    foreach ($dataBaiHats as $dataBaiHat) :
                        ...
                        $tenTheLoai = $theLoaiService->getTenTheLoai($dataBaiHat->getIdTheloai());
                ...
                ?>
                    <tr>
                        ...
                        <td scope="row"><a href="../Admin/delete.php" data-bs-toggle="modal" data-bs-target="#modalId<?= $id; ?>"><i class="fa-solid fa-trash"></i></a></td>
                    </tr>
